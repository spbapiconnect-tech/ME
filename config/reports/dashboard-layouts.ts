...
export const dashboardLayoutCatalog: DashboardLayoutContract[] = [
  ...
  {
    key: "dashboard.psi-overview",
    name: { zh: "ME PSI 运营总览", en: "ME PSI Overview" },
    description: { zh: "PSI 运营数据预览看板（只读）。", en: "Read-only PSI operational data preview dashboard." },
    targetRole: "operations-manager",
    targetPlan: "ops",
    widgets: [
    ...
    status: "preview-only",
    layoutMode: "operational",
    notes: { zh: "仅元数据和 mock 预览，不执行真实 dashboard builder。", en: "Metadata and mock preview only; no real dashboard builder execution." },
  },
  {
