...
export const meDemoStorySteps: MeDemoStoryStep[] = [
  ...
  createStep({
    ...
    highlights: [
      ...
      { zh: "v0.8.9 将进入 `/settings`、`/integration`、`/tasks` 与 `/reports/pos` 的 UI 走查", en: "v0.8.9 moves into UI walkthrough testing for `/settings`, `/integration`, `/tasks`, and `/reports/pos`" },
