...
export const meDemoStorySteps: MeDemoStoryStep[] = [
  ...
  createStep({
    ...
    highlights: [
      ...
      { zh: "v0.8.8 已完成 Settings / Integration、Role / Access 与 Package / Plan 抛光", en: "v0.8.8 completed Settings / Integration, Role / Access, and Package / Plan polish" },
      { zh: "v0.8.9 将进入 `/settings`、`/integration`、`/integration/POS-KCH-PRIMARY`、`/tasks` 与 `/reports/pos` 的 UI 走查", en: "v0.8.9 moves into UI walkthrough testing for `/settings`, `/integration`, `/integration/POS-KCH-PRIMARY`, `/tasks`, and `/reports/pos`" },
