...
export const meDemoWalkthroughItems: MeDemoWalkthroughItem[] = [
  ...
  createWalkthroughItem({
    ...
    description: localized("检查 Settings 与 Integration 的 preview-safe action wording，并确认 v0.8.8 后台治理抛光已纳入走查。", "Review Settings and Integration preview-safe action wording and confirm v0.8.8 governance polish is included in the walkthrough."),
    route: "/settings",
    surface: "system-foundation",
    checkedByDefault: false,
    isPlaceholder: true,
  ...
  createWalkthroughItem({
    ...
    description: localized("检查 Role / Access 与 Package / Plan 已经以 preview-safe SaaS 后台方式呈现，并作为 v0.8.9 UI walkthrough testing 前的最终后台检查。", "Review Role / Access and Package / Plan as preview-safe SaaS admin surfaces before v0.8.9 UI walkthrough testing."),
