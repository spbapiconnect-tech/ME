...
export const restaurantModules: RestaurantModuleDefinition[] = [
  ...
  },
  {
    ...
    status: "ui-preview-only",
    preview: {
      activeNavKey: "receiving",
      eyebrow: "Receiving",
      title: "Supplier receiving and variance workspace",
      description: "Track purchase-order receiving, quantity variance, supplier delays, and inventory posting checks in one operations surface.",
      notice: "",
      badges: [{ label: "Receiving" }, { label: "Variance review", variant: "secondary" }, { label: "Inventory handoff", variant: "outline" }],
      pageActions: [
        { label: "Open Procurement", href: "/psi/procurement" },
        { label: "Open Inventory", href: "/psi/inventory", variant: "outline" },
        { label: "Open Suppliers", href: "/psi/supplier", variant: "outline" },
      ],
      meta: [
        { label: "Branch", value: "KCH" },
        { label: "Window", value: "Today" },
        { label: "Variance watch", value: "2 records" },
        { label: "Pending verification", value: "3" },
      ],
      recordSummary: {
        title: "RCV-KCH-240507",
        subtitle: "Receiving batch review",
        status: "Awaiting verification",
        guardrail: "",
        meta: [
          { label: "PO ID", value: "PO-KCH-0098" },
          { label: "Supplier", value: "ABC Food Supply" },
          { label: "Branch", value: "KCH" },
          { label: "Expected date", value: "Today 15:00" },
          { label: "Variance", value: "1 line" },
          { label: "Inspector", value: "Warehouse Lead" },
        ],
      },
      actionBar: [
      ...
      metrics: [
        { label: "Awaiting receiving", value: "8", description: "Receiving records still open for supplier delivery confirmation." },
        { label: "Received today", value: "12", description: "Deliveries acknowledged and moved into branch review today." },
        { label: "Variance found", value: "2", description: "Two receiving lines require variance follow-up." },
      ],
      filters: [
        { label: "Branch", value: "KCH" },
        { label: "Supplier", value: "ABC Food Supply" },
      ...
      sections: [
        {
          ...
          description: "Open receiving records currently visible to branch and warehouse operations.",
          columns: ["Receiving ID", "PO ID", "Supplier", "Branch", "Expected Date", "Status"],
          rows: [
            ["RCV-KCH-240507", "PO-KCH-0098", "ABC Food Supply", "KCH", "Today 15:00", "Awaiting verification"],
            ["RCV-BTU-240507", "PO-BTU-0041", "Cold Chain Hub", "BTU", "Today 17:30", "Variance review"],
            ["RCV-HQ-240506", "PO-HQ-0015", "North Pantry Co", "Central Kitchen", "Yesterday", "Posted"],
          ],
        },
        {
          kind: "fields",
          title: "Receiving Summary",
          description: "Primary receiving metadata used to validate supplier handoff and stock posting readiness.",
          fields: [
            { label: "Expected cartons", value: "24" },
            { label: "Received cartons", value: "23" },
            { label: "Variance status", value: "One carton missing" },
            { label: "Quality check", value: "Pending sign-off" },
            { label: "Inventory posting", value: "Awaiting confirmation" },
            { label: "Document pack", value: "Invoice / photo / receiving note" },
          ],
          asideTitle: "Receiving note",
          asideBody: "Use this surface to validate delivered quantity, document any variance, and then move the batch into inventory confirmation.",
        },
      ],
      timeline: {
        title: "Receiving Activity",
        items: [
          { title: "Receiving batch opened", description: "PO-KCH-0098 entered the receiving queue for KCH.", time: "09:40" },
          { title: "Variance flagged", description: "One carton mismatch recorded during dock-side review.", time: "12:25" },
          { title: "Quality check pending", description: "Warehouse lead is waiting for final confirmation before posting.", time: "14:05" },
        ],
      },
      rightRail: [
        { title: "Receiving Status", badge: "Verification", items: ["Variance review", "Photo evidence", "Inventory handoff"] },
        { title: "Linked Surfaces", items: ["Procurement requests", "Inventory movements", "Supplier issues"] },
        { title: "Alerts", items: ["One missing carton", "Cold-chain check due", "Final sign-off pending"] },
      ],
      footerNote: "",
    },
  },
  {
    ...
    group: "system",
    surfaceType: "config",
    description: { zh: "公司、显示、审批与安全配置。", en: "Company, display, approval, and security configuration." },
    dataLayerNeeded: false,
    formulaLayerNeeded: false,
    brainLayerNeeded: false,
    permissionLayerNeeded: true,
    ...
    preview: {
      ...
      eyebrow: "Settings",
      title: "Company and system configuration workspace",
      description: "Manage display preferences, branch setup, approval rules, language, and security review from one customer-facing administration surface.",
      notice: "",
      badges: [{ label: "Settings" }, { label: "Display & language", variant: "secondary" }, { label: "Administration", variant: "outline" }],
      pageActions: [
        { label: "Open Integration", href: "/integration" },
        { label: "Open Roles", href: "/roles", variant: "outline" },
        { label: "Open Reports", href: "/reports", variant: "outline" },
      ],
      meta: [
        { label: "Company", value: "ME Branch ERP" },
        { label: "Branch setup", value: "4 active branches" },
        { label: "Theme", value: "Bright / Dark / Moon" },
      ...
      recordSummary: {
        ...
        guardrail: "",
        meta: [
          { label: "Display", value: "Multi-theme enabled" },
          { label: "Language", value: "Bilingual ready" },
          { label: "Approval rules", value: "Configured" },
          { label: "Security", value: "Monitoring" },
          { label: "Recent changes", value: "3 items" },
          { label: "Last review", value: "Today 16:10" },
        ],
      },
      actionBar: [
        { label: "Save Changes" },
      ...
      metrics: [
        { label: "Config sections", value: "8", description: "Company, branch, display, language, approval, notification, mapping, and security sections." },
        { label: "Validation issues", value: "1", description: "One configuration item still requires review before release." },
        { label: "Recent changes", value: "3", description: "Three admin updates were recorded in the current review window." },
      ],
      filters: [
        { label: "Environment", value: "Production preview" },
        { label: "Branch setup", value: "All Stores" },
        { label: "Language", value: "English / 中文" },
        { label: "Theme", value: "Bright / Dark / Moon" },
      ],
      sections: [
        {
          ...
          description: "Visible customer-facing controls aligned with the shell theme and language preferences.",
          fields: [
            { label: "Theme", value: "Bright / Dark / Moon" },
            { label: "Language", value: "English / 中文" },
            { label: "Density", value: "Comfortable / Compact / Dense" },
            { label: "Sidebar mode", value: "Expanded / Drawer" },
            { label: "Right rail", value: "Visible / Stacked" },
            { label: "Preview mode", value: "Desktop / Tablet / Mobile" },
          ],
        },
        {
          kind: "table",
          title: "Configuration Status",
          description: "Current settings areas and their latest review state.",
          columns: ["Section", "Owner", "Status", "Last Updated"],
          rows: [
            ["Company Profile", "System Admin", "Healthy", "Today 10:05"],
            ["Approval Rules", "Operations Lead", "Review", "Today 13:10"],
            ["Notification", "Operations Manager", "Healthy", "Yesterday"],
          ],
        },
      ],
      timeline: {
        ...
        items: [
          { title: "Display preferences reviewed", description: "Theme and language settings verified for customer preview.", time: "09:20" },
          { title: "Approval rule updated", description: "Procurement approval threshold was reviewed by operations.", time: "11:45" },
          { title: "Security check completed", description: "Role access review remained in healthy state.", time: "16:10" },
        ],
      },
      rightRail: [
        { title: "Validation", badge: "1 issue", items: ["One approval rule pending review", "Display preferences healthy", "Language packs active"] },
        { title: "Related Surfaces", items: ["Roles & Permission", "Integration", "Reports"] },
        { title: "Admin Focus", items: ["Theme rollout", "Branch setup review", "Security audit"] },
      ],
      footerNote: "",
    },
  },
  {
    ...
    status: "ui-preview-only",
    preview: {
      activeNavKey: "integration",
      eyebrow: "Integration",
      title: "Connector health and sync management workspace",
      description: "Track POS, devices, APIs, webhooks, and external tools with status, latency, logs, and operator actions.",
      notice: "",
      badges: [{ label: "Integration" }, { label: "Connector health", variant: "secondary" }, { label: "Sync review", variant: "outline" }],
      pageActions: [
      ...
      meta: [
        { label: "Connected apps", value: "7" },
        { label: "Healthy sync", value: "5" },
        { label: "Sync errors", value: "2" },
        { label: "Last sync", value: "Today 16:24" },
      ],
      recordSummary: {
        title: "POS-KCH-PRIMARY",
        subtitle: "Primary branch connector",
        status: "Healthy",
        guardrail: "",
        meta: [
          { label: "Connector", value: "POS" },
          { label: "Branch", value: "KCH" },
          { label: "Status", value: "Healthy" },
          { label: "Latency", value: "182 ms" },
          { label: "Last sync", value: "Today 16:24" },
          { label: "Owner", value: "System Administrator" },
        ],
      },
      actionBar: [
        { label: "Add Connector" },
      ...
      metrics: [
        { label: "Connected apps", value: "7", description: "POS, printers, APIs, and external tools currently visible in the connector center." },
        { label: "Devices online", value: "11", description: "Connected devices are reporting healthy state across active branches." },
        { label: "Sync errors", value: "2", description: "Two connectors require follow-up from the admin team." },
      ],
      filters: [
        { label: "Connector type", value: "POS / Printer / API" },
        { label: "Branch", value: "All Stores / KCH" },
        { label: "Status", value: "Healthy / Warning" },
        { label: "Window", value: "Today" },
      ],
      sections: [
        {
          ...
          description: "Connected applications and devices currently visible to system administrators.",
          columns: ["Connector", "Type", "Status", "Last Sync", "Owner", "Environment"],
          rows: [
            ["POS-KCH-PRIMARY", "POS", "Healthy", "Today 16:24", "System Administrator", "Production"],
            ["PRINTER-BTU-01", "Printer", "Warning", "Today 14:05", "Store Manager", "Production"],
            ["SUPPLIER-API-EDGE", "API", "Healthy", "Today 15:40", "Integration Lead", "Production"],
          ],
        },
        {
          kind: "cards",
          title: "Sync Summary",
          description: "Connector-level health, errors, and latency trend summary.",
          cards: [
            { title: "Healthy connectors", value: "5", description: "Connectors operating without visible sync issues." },
            { title: "Warning connectors", value: "2", description: "Connectors requiring manual follow-up or reconnection." },
            { title: "Avg latency", value: "214 ms", description: "Preview-only latency average across active endpoints." },
          ],
        },
      ],
      timeline: {
        ...
        items: [
          { title: "POS sync completed", description: "KCH primary POS connector completed the latest sync window.", time: "16:24" },
          { title: "Printer warning raised", description: "BTU printer response time exceeded the review threshold.", time: "14:05" },
          { title: "Webhook mapping checked", description: "Supplier edge API mapping remained aligned with current routes.", time: "11:30" },
        ],
      },
      rightRail: [
        { title: "Connector Health", badge: "2 warnings", items: ["Printer latency watch", "One API retry", "POS sync healthy"] },
        { title: "Admin Actions", items: ["Run connection test", "Reconnect warning device", "Review mapping logs"] },
        { title: "Related Surfaces", items: ["Settings", "Reports", "Audit Trail"] },
      ],
      footerNote: "",
    },
  },
